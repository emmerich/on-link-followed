  ...
  gulp.src('')
    ...
    .pipe(webpackStream({
      ...
      if (firstBuild) {
        ...
        $.livereload.reload('./testServer/tmp/__spec-build.js');
      }
      firstBuild = false;
    }))
    .pipe(gulp.dest('./testServer/tmp'))

  gulp.src('./test/**/*').pipe(gulp.dest('./testServer/test'))
  gulp.src('./node_modules/**/*').pipe(gulp.dest('./testServer/node_modules'))
